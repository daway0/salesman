...
urlpatterns = [
    ...
    # Sales Ledgers
    path('sales-ledgers/create/', views.sales_ledger_create_update, name='sales_ledger_create_update'),
    path('sales-ledgers/edit/<uuid:id>/', views.sales_ledger_create_update, name='sales_ledger_create_update'),
    path('sales-ledgers/', views.sales_ledger_list, name='sales_ledger_list'),
