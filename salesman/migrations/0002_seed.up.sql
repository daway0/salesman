...
BEGIN
        ...
        VIEW_SALES_HISTORY = uuid_generate_v4();
        ...
        OPERATOR_USER = uuid_generate_v4();
...
INSERT INTO SalesLedger (id, customer_id, service_id, created_by, price, sales_price, created_at, approved_by, approved_at, cancelled_by, cancelled_at, status, updated_at) VALUES 
        (uuid_generate_v4(), USER_1, SERVICE_1, OPERATOR_USER, 100, 110, now() - interval '7 days', FINANCE_USER, now() - interval '6 days', NULL, NULL, 'APPROVED', now() - interval '6 days'),
        (uuid_generate_v4(), USER_1, SERVICE_2, OPERATOR2_USER, 200, 210, now() - interval '6 days', FINANCE_USER, now() - interval '5 days', NULL, NULL, 'APPROVED', now() - interval '5 days'),
        (uuid_generate_v4(), USER_1, SERVICE_3, OPERATOR3_USER, 300, 310, now() - interval '5 days', FINANCE_USER, now() - interval '4 days', NULL, NULL, 'APPROVED', now() - interval '4 days'),
        (uuid_generate_v4(), USER_1, SERVICE_4, OPERATOR4_USER, 400, 410, now() - interval '4 days', FINANCE_USER, now() - interval '3 days', NULL, NULL, 'APPROVED', now() - interval '3 days'),
        (uuid_generate_v4(), USER_1, SERVICE_1, OPERATOR5_USER, 100, 115, now() - interval '3 days', FINANCE_USER, now() - interval '2 days', NULL, NULL, 'APPROVED', now() - interval '2 days'),
        (uuid_generate_v4(), USER_1, SERVICE_2, OPERATOR_USER, 200, 220, now() - interval '2 days', FINANCE_USER, now() - interval '1 days', NULL, NULL, 'APPROVED', now() - interval '1 days'),
        (uuid_generate_v4(), USER_1, SERVICE_3, OPERATOR2_USER, 300, 320, now() - interval '1 days', FINANCE_USER, now(), NULL, NULL, 'APPROVED', now()),
        (uuid_generate_v4(), USER_1, SERVICE_4, OPERATOR3_USER, 400, 420, now() - interval '6 days', FINANCE_USER, now() - interval '5 days', NULL, NULL, 'APPROVED', now() - interval '5 days'),
        (uuid_generate_v4(), USER_1, SERVICE_1, OPERATOR4_USER, 100, 130, now() - interval '5 days', FINANCE_USER, now() - interval '4 days', NULL, NULL, 'APPROVED', now() - interval '4 days'),
        (uuid_generate_v4(), USER_1, SERVICE_2, OPERATOR5_USER, 200, 230, now() - interval '4 days', FINANCE_USER, now() - interval '3 days', NULL, NULL, 'APPROVED', now() - interval '3 days'),
        (uuid_generate_v4(), USER_1, SERVICE_3, OPERATOR_USER, 300, 310, now() - interval '3 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '3 days'),
        (uuid_generate_v4(), USER_1, SERVICE_4, OPERATOR2_USER, 400, 410, now() - interval '2 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '2 days'),
        (uuid_generate_v4(), USER_1, SERVICE_1, OPERATOR3_USER, 100, 120, now() - interval '1 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '1 days'),
        (uuid_generate_v4(), USER_1, SERVICE_2, OPERATOR4_USER, 200, 220, now(), NULL, NULL, NULL, NULL, 'PENDING', now()),
        (uuid_generate_v4(), USER_1, SERVICE_3, OPERATOR5_USER, 300, 330, now() - interval '7 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '7 days'),
        (uuid_generate_v4(), USER_1, SERVICE_4, OPERATOR_USER, 400, 440, now() - interval '6 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '6 days'),
        (uuid_generate_v4(), USER_1, SERVICE_1, OPERATOR2_USER, 100, 140, now() - interval '5 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '5 days'),
        (uuid_generate_v4(), USER_1, SERVICE_2, OPERATOR3_USER, 200, 250, now() - interval '4 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '4 days'),
        (uuid_generate_v4(), USER_1, SERVICE_3, OPERATOR4_USER, 300, 350, now() - interval '3 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '3 days'),
        (uuid_generate_v4(), USER_1, SERVICE_4, OPERATOR5_USER, 400, 460, now() - interval '2 days', NULL, NULL, NULL, NULL, 'PENDING', now() - interval '2 days');
